...
public class ReadingController {
  ...
  public ResponseEntity<Reading> getReading(@RequestHeader("userId") String userId, @PathVariable String readingId) {
    return ResponseEntity.ok(quizService.getReading(userId, readingId));
  }

  @PostMapping("/{readingId}/complete")
  public ResponseEntity<String> completeQuiz(@RequestHeader("userId") String userId, @PathVariable String readingId) {
